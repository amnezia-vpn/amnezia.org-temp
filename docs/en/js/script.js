...
$(document).ready(function () {
    ...
    //$('#btn-personal').attr('src', deviceWin ? "screens/windows_fff.svg" : "screens/mac_fff.svg");
    //$('#link-screens-personal').attr('src', deviceWin ? "screens/mac.svg" : "screens/windows.svg");
    ...
    function generateInstructions(arr) {
        ...
        function generateImgTags(hostingData, step, imgCount) {
            ...
            for (let i = 1; i <= imgCount; i++) {
                imgTagsHtml += `<img src="screens/step_${step}/${hostingData.imgFolderName}/${i}.png">`
            }
            return imgTagsHtml;
        }
